...
import { SecureAssetsClient } from "@/components/secure-assets-client";

export const metadata: Metadata = {
    title: "Secure Assets - CardSense",
    description: "Manage secure vault records, user accounts, and user cards.",
};

export default function SecureAssetsPage() {
    return (
